...
apigClientFactory.newClient = function (config) {
    ...
    var endpoint = 'https://6mbvzs2o1g.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.apiPost = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(apiPostRequest, authType, additionalParams, config.apiKey);
    };
